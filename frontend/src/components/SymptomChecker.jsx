    ...
    <section style={{ padding: isMobile ? '60px 0' : '96px 0', background: '#f7f9f8' }}>
      <div className="section-container">
        ...
        <div className="max-w-4xl mx-auto">
            ...
            {symptoms.map(symptom => {
              ...
              return (
                <motion.button
                  ...
                  style={{
                    borderColor: isActive ? '#0fd68c' : '#e8ede9',
                    background: isActive ? '#f0fdf8' : '#ffffff',
                    boxShadow: isActive ? '0 12px 24px rgba(15,214,140,0.1)' : 'none',
                  }}
                >
                  <symptom.icon
                    size={24}
                    className="mb-3"
                    style={{ color: isActive ? '#0fd68c' : 'rgba(10,10,15,0.2)' }}
                  />
                  <p className="text-sm font-bold text-[#0a0a0f] font-[Syne] mb-1">
                    {symptom.label}
                  </p>
                  <p className="text-[0.6rem] uppercase tracking-widest font-bold text-[#0a0a0f]/25 font-[DM_Sans]">
                    {symptom.category}
                  </p>
                </motion.button>
              );
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="flex items-center gap-4">
                 <div className="w-2.5 h-2.5 rounded-full" style={{ background: selected.length > 0 ? '#0fd68c' : '#e8ede9' }} />
                 <div>
                    <p className="text-[0.65rem] font-black uppercase tracking-widest text-[#0a0a0f]/30 mb-0.5 font-[Syne]">Assessment Pipeline</p>
                    <p className="text-sm text-[#0a0a0f]/60 font-[DM_Sans]">
          ...
          <p className="text-center text-[0.6rem] font-bold uppercase tracking-widest text-[#0a0a0f]/15 mt-10 font-[DM_Sans]">
