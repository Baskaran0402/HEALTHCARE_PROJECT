                   ...
                   <div className="space-y-8">
                      <div className="p-8 bg-white border border-slate-100 rounded-[2rem] shadow-subtle group hover:shadow-premium transition-all">
                         <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                               <h4 className="text-[11px] font-black text-slate-800 uppercase tracking-widest leading-none mb-1">E2EE Verified</h4>
                               <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">End-to-end institutional tunnels</p>
                            </div>
                         </div>
                      </div>
                      <div className="p-8 bg-white border border-slate-100 rounded-[2rem] shadow-subtle group hover:shadow-premium transition-all">
                         <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                               <h4 className="text-[11px] font-black text-slate-800 uppercase tracking-widest leading-none mb-1">Zero-Trust Protocol</h4>
                               <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Continuous credential validation</p>
                            </div>
                         </div>
                      </div>
                   </div>
                   ...
                   <ClinicalCard className="p-10 md:p-16 border-teal-500/10 shadow-premium relative overflow-hidden">
                      ...
                      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 relative z-10">
                        <div>
                          ...
                          <h2 className="text-3xl font-black font-display text-slate-900 mt-4 tracking-tight">Access Portal</h2>
                        </div>
                        <div className="px-5 py-2.5 rounded-2xl bg-white border border-slate-100 flex items-center gap-3 shadow-subtle">
                           <div className="w-2 h-2 rounded-full bg-teal-500 animate-pulse" />
                           <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Auth-Node Live</span>
                        </div>
                      </div>
                      ...
                      <AnimatePresence>
                        {displayError && (
                            <motion.div 
                              ...
                              className="flex items-center gap-3 p-5 rounded-2xl mb-10 text-[10px] font-black uppercase tracking-widest bg-red-50 border border-red-100 text-red-500 relative z-10"
                            >
                                <AlertCircle size={16} />
                      ...
                      <form onSubmit={handleLogin} className="space-y-8 relative z-10">
                          ...
                          <div className="space-y-4">
                             <div className="flex justify-between items-center px-1">
                                ...
                                <button type="button" onClick={() => setShowPw(!showPw)} className="text-[9px] font-black text-teal-600 uppercase tracking-[0.2em] hover:text-teal-700 transition-colors">
                             ...
                             <input 
                                ...
                                className="w-full h-14 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold tracking-widest px-5 outline-none focus:border-teal-500/40 focus:ring-4 focus:ring-teal-500/5 transition-all"
                                required
                             />
                          </div>
                          ...
                          <div className="p-6 bg-slate-50/50 rounded-2xl border border-slate-100 flex flex-col md:flex-row items-center justify-between gap-6">
                             <div>
                                <h4 className="text-[10px] font-black text-slate-800 uppercase tracking-[0.2em] mb-1">Humanity Check</h4>
                                <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Index Challenge: 5 + 3 = ?</p>
                             </div>
                             <input 
                                type="text" 
                                placeholder="Result" 
                                ...
                                className="w-full md:w-32 h-12 bg-white border border-slate-200 rounded-xl text-center text-sm font-black tracking-widest outline-none focus:border-teal-500 transition-all"
                             />
                          </div>
                           ...
                           <div className="pt-6">
                             ...
                             <div className="mt-10 flex flex-col md:flex-row items-center justify-between gap-6 px-2">
                                <Link to="/register" className="text-[10px] font-black text-teal-600 uppercase tracking-widest hover:text-teal-700 transition-colors">
                                   New subject? Create identity →
                                </Link>
                                <a href="#" className="text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-slate-600 transition-colors">
                                   Reset Access Key
                                </a>
                             </div>
                          </div>
                      ...
                      <div className="mt-16 pt-10 border-t border-slate-50 flex flex-wrap items-center justify-center gap-10 relative z-10">
                         ...
                         <div className="flex items-center gap-2 opacity-30 grayscale saturate-0">
                            <Lock size={14} />
                            <span className="text-[8px] font-black uppercase tracking-widest">E2EE Verified</span>
                         </div>
                         <div className="flex items-center gap-2 opacity-30 grayscale saturate-0">
                            <Key size={14} />
